...
- Recommended next phase: `Phase 3E.2 - Browse/Plasmate-assisted literature sweep through gate`
...
| wang_wo3_fp_2020_non_enz_baseline | `non_enz_planar_tmm_baseline_candidate` | no | absolute_calibration_documented, geometry_specified, calibration_holdout_split_predeclared, holdout_not_known_used_for_fit |
